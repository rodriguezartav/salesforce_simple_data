...
function onData(){console.log("Query Executed"),console.log(Account.all());var o=Account.first();o.Type="Other Type "+parseInt(100*Math.random()),o.save({done:onUpdate,fail:onError})}function onUpdate(){console.log("Account Update"),createdAccount=Account.create({Name:"New Account "+parseInt(100*Math.random()),Type:"Prospect"},{done:onCreate,fail:onError})}function onCreate(){console.log("Account Created"),console.log(this),createdAccount.destroy({done:onDelete,fail:onError})}function onDelete(){console.log("Account Deleted")}function onError(o){console.log("ERROR BEGINS"),console.log("Error Ocurred"),console.log(o),console.log("Context",this),console.log(this),console.log("ERROR ENDS","\n")}var fs=require("fs");_3vot.el.innerHTML='<div class="container">\n  <div class="row ">\n\n    <h1>Welcome to your App V2</h1>\n\n  </div>  \n  \n</div>\n    \n';var Account=require("./models/account"),createdAccount;Account.query("select name,type from Account",{fail:onError}),Account.bind("refresh",onData);
},{"./models/account":3,"fs":1}],3:[function(require,module,exports){
var _3Model=require("3vot-model"),fields=["Name","Type"];Account=_3Model.Model.setup("Account",fields),module.exports=Account;
},{"3vot-model":13}],4:[function(require,module,exports){
(function() {
...
},{"./ajax_action":5,"./ajax_collection":6,"./ajax_query":7,"./ajax_request":8,"./ajax_singleton":9,"./ajax_utils":10,"./ajax_view":11,"3vot-model":13}],5:[function(require,module,exports){
(function() {
...
},{"./ajax_request":8}],6:[function(require,module,exports){
(function() {
...
},{"./ajax_request":8,"./ajax_utils":10,"./vf_request":16}],7:[function(require,module,exports){
(function() {
...
},{"./ajax_request":8,"./ajax_utils":10,"./vf_request":16,"3vot-model":13}],8:[function(require,module,exports){
(function() {
...
},{"./ajax_utils":10,"3vot-model":13,"superagent":17}],9:[function(require,module,exports){
(function() {
...
},{"./ajax_request":8,"./ajax_utils":10,"./vf_request":16,"3vot-model":13}],10:[function(require,module,exports){
(function() {
...
},{"3vot-model":13}],11:[function(require,module,exports){
(function() {
...
},{"./ajax_request":8}],12:[function(require,module,exports){
(function() {
  var Events, trim,
    __slice = [].slice;
...
},{"./events":12,"./model":14,"./module":15}],14:[function(require,module,exports){
(function() {
...
},{"./ajax":4,"./events":12,"./module":15}],15:[function(require,module,exports){
(function() {
...
},{"./ajax_utils":10,"./model":14}],17:[function(require,module,exports){
/**
 * Module dependencies.
 */
